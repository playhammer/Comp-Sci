...
public class PostageUtil
{
  ...
  public static double computePostage(double weight)
  {
	  ...
	  // Implements the second flowchart
	  return (weight<=1) ? 0.47 : ((weight>1) ? 0.47 + Math.ceil(weight - 1) * 0.21 : ((weight>3.5) ? 0.94 + Math.ceil(weight - 1) * 0.21 : 0.47 + Math.ceil(weight - 1) * 0.21));
  }
}