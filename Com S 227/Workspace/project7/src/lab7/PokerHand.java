...
public class PokerHand
{
  ...
  {
    sortNoSuit();
    return (cards[0].getRank() == cards[1].getRank() && cards[2].getRank() == cards[3].getRank() && cards[2].getRank() == cards[4].getRank())||
    		(cards[0].getRank() == cards[1].getRank() && cards[0].getRank() == cards[2].getRank() && cards[3].getRank() == cards[4].getRank());
  }
